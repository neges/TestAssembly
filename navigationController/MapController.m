...
@synthesize myMapControllerDelegate;
...
-(void)initController
{
	...
	[self.myMapControllerDelegate loadTrackingXMLforSigns:nil andStartTracking:false];
			 ...
			 withThresholdQuality: (CGFloat) thresholdQuality
{
	...
	// Wenn das Schreiben der XML-Datei nicht eroflgreich war
	if( [ xmlString writeToFile:xmlFile atomically:YES encoding:NSUTF8StringEncoding error:nil ] )
	{
		[myMapControllerDelegate loadTrackingXMLforSigns:xmlFile andStartTracking:false];
	}
	else
	{
