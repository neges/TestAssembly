...
public:
	...
	*/
	...
	/**
	* \brief Returns the (4x4) matrix representation of this rotation
	*
	* \param rotationMatrix Rotation matrix (4x4) array row major
	*/
	void getRotationMatrix4x4(float rotationMatrix[16]) const;
